...
firebase.auth().onAuthStateChanged(async function (user) {
    ...
    console.log('signed in')
        ...
        <div class = "text-white font-bold">Signed in as ${user.displayName}</div>
        <button class="text-pink-500 p-2 m-2 bg-gray-200 border border-indigo-600 underline sign-out">Sign Out</button>
        `
        ...
        let response = await fetch(`https://api.themoviedb.org/3/movie/now_playing?api_key=07e4a6bb30cbf0a6764ad6f0efbd1302&language=en-US`)
